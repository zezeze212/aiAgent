...
class AgentLogServiceTest {
	...
	void shouldSaveFailedRunWhenAnyStepFails() {
		AgentTraceStep failedStep = new AgentTraceStep("TOOL_EXECUTION", "执行工具", false, 10L, "{}", "工具执行失败", "参数错误");
	...
	void shouldSaveSuccessfulRunWhenAllStepsSucceed() {
		AgentTraceStep decisionStep = new AgentTraceStep("AI_DECISION", "判断是否需要工具", true, 10L, "{}", null, null);

		AgentTraceStep toolStep = new AgentTraceStep("TOOL_EXECUTION", "执行工具", true, 10L, "{}", null, null);
