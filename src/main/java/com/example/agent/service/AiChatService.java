...
public class AiChatService {
	...
	public String chat(String userMessage) {
		return callDeepSeek(
				List.of(Map.of("role", "system", "content", "你是一个帮助 Java 后端学习 AI Agent 开发的助手，回答要清晰、具体、分步骤。"),
	...
	private List<Map<String, String>> buildErrorAnalyzeMessages(String logText) {
		return List.of(Map.of("role", "system", "content", """
				...
				"""), Map.of("role", "user", "content", "请分析下面这段报错日志：\n" + logText));
	}
	...
	private String callDeepSeek(List<Map<String, String>> messages) {
		...
		try {
			...
			log.info("DeepSeek 调用成功，requestId={}, contentLength={}", requestId, content == null ? 0 : content.length());
